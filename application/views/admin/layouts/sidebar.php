            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <?php if ($this->session->userdata('level') != 'Caraka') { ?>

                        <?php if ($this->session->userdata('level') == 'Kepala Satuan' || $this->session->userdata('level') == 'Sesdis/Kasub') { ?>
                        

                        <?php if ($this->session->userdata('level') == 'Kepala Satuan') { ?>
                        ...
                        <?php if ($this->session->userdata('level') == 'Kabag' || $this->session->userdata('level') == 'Personel') { ?>

                        <?php } ?>

                        <?php } ?>

                        <?php if ($this->session->userdata('level') == 'Kabag' || $this->session->userdata('level') == 'Personel' || $this->session->userdata('level') == 'Kepala Satuan' || $this->session->userdata('level') == 'Sesdis/Kasub' || $this->session->userdata('level') == 'Caraka') { ?>
                        ...
                        <?php if ($this->session->userdata('level') == 'Caraka' || $this->session->userdata('level') == 'Admin') { ?>
